...
import { App, Ref as Ref$1 } from 'vue';
...
type DatabaseSnapshotSerializer = typeof createRecordFromDatabaseSnapshot;
 ...
 */
type VueDatabaseQueryData<T = unknown> = Array<Exclude<VueDatabaseDocumentData<T>, null>>;
 ...
 */
declare function useCurrentUser(): Ref$1<User | null | undefined>;
/**
 ...
 */
declare function useAppCheckToken(): Ref$1<string | undefined>;
...
declare function useStorageUrl(storageRef: _MaybeRef<_Nullable<StorageReference>>): {
    url: vue.Ref<string | null | undefined>;
    refresh: () => {
...
declare function useStorageMetadata(storageRef: _MaybeRef<_Nullable<StorageReference>>): {
    metadata: vue.ShallowRef<FullMetadata | null | undefined>;
    update: (newMetadata: SettableMetadata) => Promise<FullMetadata | null>;
    refresh: () => Promise<FullMetadata | null>;
    promise: vue.ShallowRef<Promise<FullMetadata | null>>;
};
/**
...
declare function useStorageObject(storageRef: _MaybeRef<_Nullable<StorageReference>>): {
    url: vue.Ref<string | null | undefined>;
    metadata: vue.ShallowRef<FullMetadata | null | undefined>;
    snapshot: vue.ShallowRef<UploadTaskSnapshot | null | undefined>;
    uploadTask: vue.ShallowRef<UploadTask | null | undefined>;
    uploadError: vue.ShallowRef<StorageError | null | undefined>;
    uploadProgress: vue.ComputedRef<number | null>;
    upload: (newData: Blob | Uint8Array | ArrayBuffer, newMetadata?: UploadMetadata) => void;
